...
<div class="container">
  <div class="row">
    <div class="col-md-6">
      ...
      <p><a class="btn btn-sunflower shadow-none outline-none" href="{{ route('campaign.index') }}" role="button">
        View Campaigns &raquo;</a>
      </p>
    </div>
    <div class="col-md-6">
      ...
      <p><a class="btn btn-sunflower shadow-none outline-none" href="{{ route('campaign.create') }}" role="button">Create a campaign &raquo;</a></p>
    </div>
  </div>
  <hr>
</div>
